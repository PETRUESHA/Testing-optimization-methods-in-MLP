...
RESULT_PATH = "/home/peivzarenkov/mlip-4/Testing-optimization-methods-in-MLP/task4/results/results_mtp_my_sgd_batch_size_experiment.csv"
...
def write_row_with_history(
    ...
    with open(filename, "a") as f:
        f.write(
            f"{batch_size},{max_steps},{pot_num},"
...
for batch_size in batch_sizes:
    ...
    for pot_num in range(1, 6):
        ...
        if rank == 0:
            ...
            print(f"BATCH_SIZE: {batch_size} MAX_STEPS: {max_steps} POT: {pot_num}")
