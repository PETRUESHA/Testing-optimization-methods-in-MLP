...
for pot_num in range(1, 6):
    ...
    # ВАЖНО: имя класса должно совпадать с тем, как ты его назвал в utils.optimizers
    # Если у тебя класс называется иначе — просто поменяй строку ниже.
    ...
    if rank == 0:
        ...
        print("MY ADAM TIME:", train_time, "STEPS:", steps_done, "EPOCHS:", epochs_done, "FINAL_LOSS:", final_loss)
        print()
