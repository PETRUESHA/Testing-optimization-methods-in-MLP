...
if rank == 0:
    with open("results_mtp_scipy_bfgs_intervals.csv", "w") as f:
        f.write(
            "interval,pot_num,"
...
for interval in intervals:
    ...
    for pot_num in range(1, 6):
        ...
        if rank == 0:
            ...
            pot.params[:] = np.random.uniform(low=interval[0], high=interval[1], size=len(pot.params))
        ...
        if rank == 0:
            ...
            with open("results_mtp_scipy_bfgs_intervals.csv", "a") as f:
                f.write(
                    f"{interval},"
                    f"{pot_num},"
