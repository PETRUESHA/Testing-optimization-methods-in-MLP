...
RESULT_PATH = "/home/peivzarenkov/mlip-4/Testing-optimization-methods-in-MLP/all_mtp_5000/results/AgPd_results_mtp_native_bfgs.csv"
...
if rank == 0:
    ...
    with open(RESULT_PATH, "w") as f:
        f.write(
            "pot_num,train_energy_rmse,train_energy_atom_rmse,train_forces_rmse,"
...
for pot_num in range(1, 6):
    ...
    trainer.train(pot, max_iter_count=5000)
