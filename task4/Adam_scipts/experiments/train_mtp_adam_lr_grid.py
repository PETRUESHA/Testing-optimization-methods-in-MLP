...
RESULT_PATH = "/home/peivzarenkov/mlip-4/Testing-optimization-methods-in-MLP/task4/results/results_mtp_adam_lr_grid.csv"
...
for lr in lr_grid:
    for pot_num in range(1, 6):
        ...
        if rank == 0:
            ...
            print(f"LR: {lr} POT: {pot_num}")
            print("ADAM LR-GRID TRAIN:", train_fit_errors)
            print("ADAM LR-GRID VALID:", val_fit_errors)
