...
RESULT_PATH = "/Users/peterzarenkov/projects/course_work/Testing-optimization-methods-in-MLP/all_etn_5000/results/MoNbTaVW_results_etn_my_muon_factorization.csv"
...
for pot_num in range(1, 6):
    ...
    if rank == 0:
        ...
        print(f"POT: {pot_num}")
        print("ETN MUON FACTORIZATION TRAIN:", train_fit_errors)
        print("ETN MUON FACTORIZATION VALID:", val_fit_errors)
        print(
            "ETN MUON FACTORIZATION TIME:",
            train_time,
            "STEPS:",
            steps_done,
            "EPOCHS:",
