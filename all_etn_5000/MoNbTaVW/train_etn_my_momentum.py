...
RESULT_PATH = "/Users/peterzarenkov/projects/course_work/Testing-optimization-methods-in-MLP/all_etn_5000/results/MoNbTaVW_results_etn_my_momentum.csv"
...
for pot_num in range(1, 6):
    ...
    if rank == 0:
        ...
        print(f"POT: {pot_num}")
        print("ETN MOMENTUM TRAIN:", train_fit_errors)
        print("ETN MOMENTUM VALID:", val_fit_errors)
        print(
            "ETN MOMENTUM TIME:",
            train_time,
            "STEPS:",
